...
def find_token_index(tokens, start_pos, end_pos, phrase):
    ...
    assert (
        start_idx != -1
    ), "start_idx: {}, start_pos: {}, phrase: {}, tokens: {}".format(
    ...
    assert (
        end_idx != -1
    ), "end_idx: {}, end_pos: {}, phrase: {}, tokens: {}, chars:{}".format(
...
def verify_result(data):
    ...
    for item in data:
        ...
        for entity_mention in item["golden-entity-mentions"]:
            if check_diff(
                "".join(words[entity_mention["start"] : entity_mention["end"]]),
                entity_mention["text"].replace(" ", ""),
            ):
                print("============================")
        ...
        for event_mention in item["golden-event-mentions"]:
            ...
            if check_diff(
                "".join(words[trigger["start"] : trigger["end"]]),
            ...
            for argument in event_mention["arguments"]:
                if check_diff(
                    "".join(words[argument["start"] : argument["end"]]),
    ...
    for file in tqdm(files):
        ...
        for item in parser.get_data():
            ...
            try:
                ...
                print(
                    "[Warning] StanfordCore Exception: ",
                    nlp_res_raw,
            ...
            for entity_mention in item["golden-entity-mentions"]:
                ...
                head_dep = deps[head_start_idx]
                entity_mention["head"]["dep"] = head_dep
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data",
        help="Path of ACE2005 English data",
        default="./data/ace_2005_td_v7/data/English",
    )
    parser.add_argument(
        "--nlp",
        help="Standford Core Nlp path",
